package tasks;/*Вам будут предоставлены два непустых связанных списка, представляющих два неотрицательных целых числа.
...
public class AddTwoNumbers__2 implements Task{
    @Override
